    ...
    <div class="panel-body">
        ...
        {{ Form::open(['url' => 'receptionist/token/create', 'class'=>'manualFrm mt-1 col-md-7 col-sm-8']) }}
            ...
            <div class="form-group @error('counter_id') has-error @enderror">
                {{--  <label for="counter_id">Counter<i class="text-danger">*</i></label><br/>  --}}
                <input type="hidden"  name="counter_id" id="counter_id" class="form-control" placeholder=" " value="17">
            ...
            <div class="form-group @error('department_id') has-error @enderror">
                ...
                <input type="hidden" name="department_id" id="department_id" class="form-control" placeholder=" " value="8">
            ...
            <div class="form-group @error('customer_name') has-error @enderror">
                <label for="customer_name">Customer Name<i class="text-danger">*</i></label><br/>
                <input type="text" name="customer_name" id="customer_name" class="form-control" placeholder="Enter Customer Name" value="">
                <span class="text-danger">{{ $errors->first('customer_name') }}</span>
            </div>

            <div class="form-group @error('ptime') has-error @enderror">
                <label for="ptime">Processing Time<i class="text-danger">*</i></label><br/>
                <input type="number" name="ptime" id="ptime" class="form-control" placeholder="Set Processing Time in mins" value="">
            ...
            <div class="form-group @error('user_id') has-error @enderror">
                <label for="user">Assigned to Staff<i class="text-danger">*</i></label><br/>
            ...
            <div class="form-group @error('note') has-error @enderror">
                <label for="note">note<i class="text-danger">*</i></label>
                <textarea name="note" id="note" class="form-control"  placeholder="addname">{{ old('note') }}</textarea>
      ...
      $.ajax({
        ...
        success: function(data)
        {
            if (data.status)
            {
                ...
                content += "<li><strong>Customer Name</strong>"+data.token.customer_name+"</li>";
                content += "<li><strong>Processing Time(mins)</strong>"+data.token.ptime+"</li>";
                ...
                content += "<li><strong> Staff </strong>"+data.token.firstname+' '+data.token.lastname+"</li>";
                if (data.token.note)
                {
